...
const handleHourBlur = () => {
  let value = formData.value.hour
  
  if (value === '') {
    formData.value.hour = '00'
  } else {
    const numValue = parseInt(value)
    if (numValue > 23) {
      formData.value.hour = '23'
    } else {
      formData.value.hour = String(numValue).padStart(2, '0')
    }
  }
...
const handleMinuteBlur = () => {
  let value = formData.value.minute
  
  if (value === '') {
    formData.value.minute = '00'
  } else {
    const numValue = parseInt(value)
    if (numValue > 59) {
      formData.value.minute = '59'
    } else {
      formData.value.minute = String(numValue).padStart(2, '0')
    }
  }
