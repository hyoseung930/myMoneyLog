...
export const useTransactionStore = defineStore('transaction-new', () => {
  ...
  function generateDummyData(): Transaction[] {
    const dummyData: Transaction[] = [
      ...
      { id: '4', date: '2025-12-04', amount: 150000, type: 'income', category: '급여', description: '월급', accountId: '1' },
      { id: '5', date: '2025-12-04', amount: 50000, type: 'expense', category: '식비', description: '식료품', accountId: '1' },
      { id: '6', date: '2025-12-06', amount: 100000, type: 'income', category: '부수입', description: '프리랜서', accountId: '1' },
